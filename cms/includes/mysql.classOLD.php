...
class MySQL
{
	 ...
	 */
	public function __construct($connect=true, $database="", $server="", $username="", $password="", $charset="", $debug=false) {
   ...
   /**
	 ...
	 */
	public function showFriendlyError() {
		echo "<p class=\"mysqlError\">Erro na sintaxe mySQL: <span class=\"error\">".$this->Error()."</span></p><pre>".$this->last_sql."</pre>";
		die();
	}
