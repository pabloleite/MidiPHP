	...
	<form name="multipleExclusionForm" id="multipleExclusionForm" method="post" enctype="multipart/form-data">
		<table width="100%" border="0" cellpadding="5" cellspacing="0" id="listData">
		  <tr>
			...
			<th><?=AdminKernel::getThOrderLabel("Identificação", "$mainSession.nome");?></th>
			<th width="60"> </th>
		  </tr>
		<?
		  $trId = 0;
...
<?
	...
	AdminKernel::showMsgInfo("Não há cupons cadastrados. Para cadastrar, clique no botão acima.");
}
?>
