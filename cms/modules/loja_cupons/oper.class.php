...
class Oper {
	...
	private function insert() {
		...
		$values['code'] = MySQL::SQLValue($_REQUEST[code]);
		$values['tipo'] = MySQL::SQLValue($_REQUEST[tipo]);
		$values['valor'] = MySQL::SQLValue(str_replace(',', '.', $_REQUEST[valor]));
	...
	private function edit() {
		...
		$values['code'] = MySQL::SQLValue($_REQUEST[code]);
		$values['tipo'] = MySQL::SQLValue($_REQUEST[tipo]);
		$values['valor'] = MySQL::SQLValue($_REQUEST[valor]);
