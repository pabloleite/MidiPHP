...
if(1)
{
	...
	$mail_data['nome'] = 'Ramon';
	$mail_data['orderid'] = '000231';
	$mail_data['pgto_forma'] = 'Pagamento Digital';
	$mail_data['frete_mode'] = 'Sedex';
	$mail_data['data'] = '10/01/2011';
	$mail_data['state'] = 'Pronto para envio';
	$mail_data['rastreamento'] = 'ASDQW3E423SDF';
}
?>
...
<div id="wraper" class="mail-sized">
	...
	<div id="main" class="cliente_pedido">
		...
		<div id="fot">
		<!--	Você pode responder neste mesmo e-mail. A mensagem será encaminhada diretamente ao remetente-->
			<a href="http://www.rumocerto.com.br">www.rumocerto.com.br</a>
